...
class ShoppingCart:
    ...
    def add_product(self, product, quantity):
        if quantity <= 0:
            print("Invalid quantity value. Quantity should be greater than 0.")
            return
...
# Perform checkout and print the total price
customer.checkout()

# Try to add a negative quantity of a product
customer.add_to_cart(product1, -1)

# Try to remove more quantity of a product than what's in the cart
customer.remove_from_cart(product2, 4)
